...
contract FestManager {
    ...
    struct EventStruct {string title; string date; uint capacity; uint registeredCount; uint voteCount; bool active;
    }
    ...
    function registerForEvent(uint _eventId) public {
        ...
        require(
            events[_eventId].registeredCount < events[_eventId].capacity,
            "Event full"
        );
